-- Создаем базу данных
create database gt41_42e;

-- Используем эту базу данных, для дальнейших запросов
use gt41_42e;
...
insert into artist
values('John', 'Smith', 19, 'm');

insert into artist
values('Lily', 'Hardy', 29, 'f'),
('Diana', 'Lorentz', 25, 'f');
...
insert into customers(fullname, gender)
values('John Smith', 'm');

select * from customers;

insert into customers(fullname, gender)
values('Daniel Faviet', 'm'),
('Diana Lorentz', 'f'),
('Laura Smith' , 'm');
...
-- 2. Используя файл employees.txt заполнить таблицу,
